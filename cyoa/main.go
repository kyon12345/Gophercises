...
func main() {
	...
	filename := flag.String("file", "gopher.json", "thr JSON file with the CYOA story")
	flag.Parse()
	fmt.Printf("Using story in %s .\n", *filename)

	//open JSON file and parse the story in it
	...
	//create a ServerMux to route our requests
